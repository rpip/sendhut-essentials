# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-06-11 11:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('stores', '0012_auto_20180607_0031'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('unused', 'unused'), ('used', 'used'), ('redeemed', 'redeemed')], default='unused', max_length=20, verbose_name='Status')),
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='coupon', to='cart.Cart')),
            ],
            options={
                'db_table': 'coupon',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', jsonfield.fields.JSONField(blank=True, max_length=360, null=True)),
                ('uuid', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, unique=True)),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='giveaways', to='accounts.Address')),
                ('giveaway', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to='giveaways.GiveAway')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', jsonfield.fields.JSONField(blank=True, max_length=360, null=True)),
                ('uuid', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, unique=True)),
                ('giveaway', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stores', to='giveaways.GiveAway')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='giveaways', to='stores.Store')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='coupon',
            name='giveaway',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coupons', to='giveaways.GiveAway', verbose_name='GiveAway'),
        ),
        migrations.AddField(
            model_name='coupon',
            name='user',
        ...
        migrations.AlterUniqueTogether(
            name='giveawaystore',
            unique_together=set([('giveaway', 'store')]),
        ),
        migrations.AlterUniqueTogether(
            name='giveawaydropoff',
            unique_together=set([('giveaway', 'address')]),
        ),
        migrations.AlterUniqueTogether(
            name='coupon',
            unique_together=set([('giveaway', 'user', 'code')]),
        ),
    ]
