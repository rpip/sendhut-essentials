# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-28 17:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.DateTimeField(blank=True, null=True)),
                ('uuid', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, unique=True)),
                ('role', models.IntegerField(blank=True, choices=[(0, 'Member'), (1, 'Admin')], default=0, null=True)),
                ('allowance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='members', to='dashboard.Allowance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(blank=True, choices=[(0, 'Member'), (1, 'Admin')], default=0, null=True)),
                ('allowance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.Allowance')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invited_employees', to='dashboard.Company')),
            ],
            options={
                'db_table': 'invite',
            },
        ...
        migrations.AddField(
            ...
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allowances', to='dashboard.Company'),
        ),
        migrations.AddField(
            model_name='allowance',
            name='created_by',
