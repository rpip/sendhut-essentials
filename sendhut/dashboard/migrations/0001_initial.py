    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, default='SlateGray-Jennifer-Knoll', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.DateTimeField(blank=True, null=True)),
                ('uuid', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, unique=True)),
                ('allowance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.Allowance')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='allowance',
            name='members',
            field=models.ManyToManyField(related_name='allowances', through='dashboard.AllowanceGroup', to='dashboard.Employee'),
        ),
    ]
