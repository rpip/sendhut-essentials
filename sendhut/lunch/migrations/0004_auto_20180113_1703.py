    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monetary_limit', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='NGN', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', jsonfield.fields.JSONField(blank=True, null=True)),
                ('group_cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lunch.GroupCart')),
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_order', to='lunch.Order'),
        ),
        migrations.AddField(
            model_name='groupcart',
            name='owner',
        ...
        migrations.AddField(
            model_name='groupcart',
            name='payment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lunch.Payment'),
        ),
        migrations.AddField(
            model_name='groupcart',
            name='vendor',
