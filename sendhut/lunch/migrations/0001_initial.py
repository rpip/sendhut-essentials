# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-17 00:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dietary_labels', models.CharField(choices=[(0, 'gluten free'), (1, 'dairy free'), (2, 'vegan'), (3, 'paleo')], max_length=2)),
            ],
            options={
                'db_table': 'item',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[(0, 'Menu'), (1, 'Breakfast'), (2, 'Lunch'), (3, 'Dinner'), (4, 'Weekend Special')], default=0, max_length=2)),
            ],
            options={
                'db_table': 'menu',
            },
        ...
        migrations.AddField(
            model_name='sideitem',
            name='menu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='lunch.SideMenu'),
        ),
        migrations.AddField(
            model_name='menu',
            name='partner',
